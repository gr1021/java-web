...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			function del(cid){
				var flag = confirm("你确定要删除该分类吗？");
				if(flag == true){
					window.location.href="${pageContext.request.contextPath}/AdminCategoryServlet?method=remove&cid="+cid;	
				}
			}
		</script>
	</HEAD>
							...
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<c:forEach var="c" items="${ list }" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/AdminCategoryServlet?method=remove&cid=${c.cid}" onclick="del('${c.cid}')">
