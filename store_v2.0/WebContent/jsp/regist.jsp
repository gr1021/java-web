...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/messages_zh.js"
	charset="UTF-8"></script>
<script type="text/javascript"
		 ...
		 $("#s1").validate({
			...
			rules : {
				username : {
					...
					username_reg : true,
					remote : {
						url : "${pageContext.request.contextPath}/UserServlet?method=checkUsername", //后台处理程序
						type : "post", //数据发送方式
						data : { //要传递的数据
							username : function() {
								return $("#username").val();
	...
	$(function(){
		$.post("${pageContext.request.contextPath}/CategoryServlet",{"method":"findAll"},function(data){
			...
			$(data).each(function(index,value){
				$("#menuID").append("<li><a href='${pageContext.request.contextPath}/ProductServlet?cid="+value.cid+"&method=findByCid&currPage=1'>"+value.cname+"</a></li>");
			});
		},"json");
	});
			...
			<div class="container-fluid">
				...
				<div class="col-md-3" style="padding-top:20px">
					<ol class="list-inline">
						...
						<li><a href="${pageContext.request.contextPath}/UserServlet?method=">购物车</a></li>
					</ol>
				</div>
			</div>
			<!--
	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form  action="${pageContext.request.contextPath }/UserServlet" class="form-horizontal" style="margin-top: 5px;" id="s1"
					method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="password"  name="repassword" class="form-control" id="confirmpwd"
								placeholder="请输入确认密码">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="tel" name="tel">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input style="height: 30px" type="text" readonly="readonly" class="form-control Wdate" name="birthday" onclick = "WdatePicker({el:this,dateFmt:'yyyy-MM-dd'})">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" name="checkImg" id="inputPassword3"
							placeholder="请输入验证码">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<input type="submit" width="100" id="regbut"  value="注册" 
								border="0"
